...
class AutoCompleteSelectWidget(forms.widgets.TextInput):
    ...
    def render(self, name, value, attrs=None):
        ...
        return mark_safe(render_to_string(('autocompleteselect_%s.html' %
            self.channel, 'autocompleteselect.html'),context))
...
class AutoCompleteSelectField(forms.fields.CharField):
    ...
    def __init__(self, channel, *args, **kwargs):
        ...
        if not widget or not isinstance(widget, AutoCompleteSelectWidget):
            widget = AutoCompleteSelectWidget(channel=channel,
...
class AutoCompleteSelectMultipleWidget(forms.widgets.SelectMultiple):
    ...
    def __init__(self,
                 channel,
                 help_text='',
                 # admin will also show help. set True if used outside of admin
...
class AutoCompleteSelectMultipleField(forms.fields.CharField):
    ...
    def __init__(self, channel, *args, **kwargs):
        ...
        kwargs['widget'] = AutoCompleteSelectMultipleWidget(channel=channel,
            help_text=help_text, show_help_text=show_help_text)
...
class AutoCompleteField(forms.CharField):
    ...
    def __init__(self, channel, type="text", *args, **kwargs):
        ...
        widget = AutoCompleteWidget(channel,type, help_text=kwargs.get(
...
def _check_can_add(self,user,model):
    ...
    it implements can_add() else using django's default perm check.
